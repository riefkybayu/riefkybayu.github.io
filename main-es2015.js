...
const PROJECTS = [
    { id: 1, name: 'Steam-Voucher-Value API', deskripsi: 'RESTful API yang berfungsi untuk memberikan data harga dan nilai. Data diperoleh dengan webscrapping itemku dan request exchangerates dari public API', gambar: '../assets/img/project/prog_api.jpg', skill: ['JavaScript', 'Nodejs', 'ExpressJS', 'Puppeteer', 'Request-Promise', 'Cors', 'JSON'], gitlink: 'https://github.com/riefkybayu/steam-voucher-value-API' },
    { id: 2, name: 'Program Bengkel Kendali Motor', deskripsi: 'Program dibuat untuk bengkel yang berfungsi untuk penyetokan barang, transaksi, dan pelaporan(keuntungan dan ketersediaan).', gambar: '../assets/img/project/prog_bengkel.jpg', skill: ['Java', 'Netbeans', 'Jasper Report', 'MariaDB'], gitlink: 'https://github.com/riefkybayu/kendali_motor_bengkel_system' },
    { id: 3, name: 'Aplikasi Penerimaan Siswa Baru SMP 1 PGRI Ciputat', deskripsi: 'Aplikasi berfungsi untuk mengatur penerimaan siswa baru, beserta pendataan pembayaran dan pemberian aksesoris sekolah', gambar: '../assets/img/project/prog_smp.jpg', skill: ['Java', 'Netbeans', 'Jasper Report', 'MariaDB'], gitlink: 'https://github.com/riefkybayu/PenerimaanSiswa' },
];
...
const WEBS = [
    ...
    { id: 6, name: 'NodeJS', deskripsi: 'NodeJS is a backend environment for JavaScript. I use NodeJS + ExpressJS as base to create RESTful API. NodeJS comes with lots of modules that can be installed and used easily as most of them are well-documented', gambar: '../assets/img/skilllogo/nodejs-small.png', tingkat_int: '80%', tingkat_str: 'Intermediate' },
];
const PROGRAMS = [
...
module.exports = ".cus-shadow{\r\n    text-shadow: rgb(255, 255, 255) 1px 1px 2px;\r\n    -webkit-font-smoothing: antialiased;\r\n}\r\n.cus-text-background{\r\n\tbackground-image: url('grey.jpg')\r\n}\r\n.cus-text-background-card{\r\n\tbackground-color:aliceblue;\r\n}\r\n@media only screen and (max-width: 767px) {\r\n  .sembunyikan-kecil{\r\n\tdisplay : none;\r\n}\r\n}\r\n.scroll-pls{\r\n\theight:350px;\r\n\tposition: relative;\r\n\toverflow-y: scroll;\r\n\tscroll-behavior: smooth;\r\n}\r\n.text-lebar{\r\n\twidth: 40%;\r\n\tposition:relative;\r\n}\r\n.row {\r\n  display: flex;/* equal height of the children */\r\n}\r\n.col {\r\n  flex: 1; /* additionally, equal width */\r\n  padding: 1em;\r\n  border: solid;\r\n}\r\nh3 span{ \r\n  padding-top: 40px;\r\n  margin-top: -40px;\r\n  display: inline-block;\r\n  vertical-align: top;\r\n}\r\na.anchor {\r\n    display: block;\r\n    position: relative;\r\n    top: -50px;\r\n    visibility: hidden;\r\n}\r\n/*# sourceMappingURL=data:application/json;base64, */"
